...
uri = "https://gateway-lon.watsonplatform.net/speech-to-text/api/v1/customizations/"+env.get_language_id()+"/corpora/"+corpus_file
...
uri = "https://gateway-lon.watsonplatform.net/speech-to-text/api/v1/customizations/"+env.get_language_id()+"/words?sort=count"
r = requests.get(uri, auth=(env.get_username(),env.get_password()), verify=False, headers=headers)
